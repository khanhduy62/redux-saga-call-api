...
export class MediaGalleryPage extends Component {
  ...
  handleSelectImage(selectedImage) {
    console.log("handle click ", this.props.selectImageAction)
...
const mapDispatchToProps = (dispatch) => ({
  searchMediaAction: (name) => dispatch(searchMediaAction(name)) ,
  selectVideoAction: (name) => dispatch(selectVideoAction(name)) , 
  selectImageAction: (name) => dispatch(selectImageAction(name))
...
export default connect(
  mapStateToProps,
  mapDispatchToProps)(MediaGalleryPage);
